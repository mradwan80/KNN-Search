...
void DDS::kNNsearchWithSortVarRad(int k, float SearchRad)
{
	float milliseconds;
	...
	CreateNbsOffsetArrayCudaSV(qnum, qncount, qnoffset); //offset//
	...
	FillDistanceCudaSV(qnum, sPixelsNum, qscount, qsoffset, qkfound, globalW, globalH, matrixVM, matrixPVM, vpos, qrads, cellWidth, xfcount, xfoffset, FragVertex, FragDepth, qncount, qnoffset, NbVertex, NbVertexDist); //fill//
	
	SortNeighborsCudaSV(NbsNum, NbVertex, NbVertexDist); //sort//
	...
	CopyKNeighborsCudaSV(qnum, qncount, NbsNum, NbVertex, Nbs);
